...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-[20%] start-[-5%] h-[35vw] w-[35vw] rounded-full ambient-glow-purple opacity-40 pointer-events-none" />
      <div className="absolute bottom-[10%] end-[5%] h-[40vw] w-[40vw] rounded-full ambient-glow-blue opacity-35 pointer-events-none" />
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {/* Elegant active selection indicator dot */}
                  {isActive && (
        ...
        <header className="glass-header flex h-16 items-center justify-between px-6 shadow-sm border-b border-border/40">
          ...
          <div className="hidden md:block">
            <span className="text-xs font-semibold text-muted-foreground tracking-widest uppercase">
              {t('app.tagline', { defaultValue: 'لوحة التحكم للمسؤول' })}
            </span>
          </div>
